...
const ChallengeWindow = styled.div`
	display: flex;
	height: 100%;
	width: 100%;
	text-align: center;
...
const ChallengeRejectButton = styled.button`
	grid-column: 1;
	padding: 1.5rem;
	text-align: center;
	margin: auto;
...
const ChallengeAcceptButton = styled.button`
	grid-column: 2;
	padding: 1.5rem;
	text-align: center;
	margin: auto;
...
const GameStartContainer = styled.div`
	display: grid;
	grid-template-rows: 4rem auto 32rem 4rem;
	grid-template-columns: 1fr 1fr;
	margin: 2% auto 4rem;
	width: 100%;
	max-width: 1200px;
...
const WinAgainButton = styled.button`
	grid-column: 1 / span 2;
	padding: 1.5rem;
	text-align: center;
	margin: auto;
