...
import ChallengedByScreen from './ChallengedByScreen';
import WaitAfterChallengeScreen from './WaitAfterChallengeScreen';
...
export default function GameWindow() {
  ...
  const renderChild = (timeline) => {
    console.log(`renderChild: dismount=${dismount}, timeline=${timeline}`);
    return timeline === 'init' ? (
      ...
      <WaitAfterChallengeScreen
        playBgSound={playBgSound}
        checkIfMusicPaused={checkIfMusicPaused}
        dismount={dismount}
        setDismount={setDismountProp}
      />
    ) : (timeline === 'setup' || timeline === 'ships placed') ? (
      <GameSetup
        dismount={dismount}
  ...
  return (
    <MainWindow  id="MainWindow">
      <VolumeContainer timeline={timeline} id="VolumeContainer">
        {volume ? (
