...
function FriendlyWatersGrid() {
	...
	return (
		<WatersContainer row='5' id="myWatersContainer">
			<SetupGridContainer id="myShipSetupGridContainer">
				<GameBoardGrid id="myShipGameBoardGrid">
					{ships.map((ship) => {
			...
			<SetupGridContainer id="myFillSetupGridContainer">
				<GameBoardGrid id="myFillGameBoardGrid">{fillCells()}</GameBoardGrid>
			</SetupGridContainer>
		</WatersContainer>
	);
}
